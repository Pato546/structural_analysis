...
Welcome to ``structural_analysis`` contributor's guide.
...
If you experience bugs or general issues with ``structural_analysis``, please have a look
...
You can help improve ``structural_analysis`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``structural_analysis`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``structural_analysis``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n structural_analysis python=3 six virtualenv pytest pytest-cov
    conda activate structural_analysis
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/structural_analysis.git
...
#. Install |pre-commit|_::
   ...
   ``structural_analysis`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/structural_analysis
.. _issue tracker: https://github.com/<USERNAME>/structural_analysis/issues
.. <-- end -->
